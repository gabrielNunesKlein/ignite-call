...
import { convertTimeStringToMinutes } from "@/src/utils/contert-time-string-to-minutes";
...
const timeIntervalsFormSchema = z.object({
    ...
    .refine(intervals => {
        ...
        message: 'O horáro de término precisa ter pelo menos 1h distante do inicio.'
    })
})
...
export default function TimeIntervals(){
    ...
    const { register, control, watch, handleSubmit, formState: { isSubmitting, errors } } 
    ...
    return (
        <Container>
            <Header>
                ...
                <Text>
                    Define o intervalo do hórario que você está disponivel em cada dia da semana.
                </Text>
